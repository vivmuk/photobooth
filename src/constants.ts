...
export const AI_STYLE_PROMPTS: Record<AIStyle, string> = {
  ...
  [AIStyle.CARTOON]: "Transform this photo into an upscale Polo Bar scene. Dress every person in well-fitted Ralph Lauren polo shirts with tasteful, classic colors and subtle logos. Place them in a refined bar setting with polished wood, leather seating, and warm ambient lighting, keeping faces and expressions clear and recognizable.",
};
