...
export const AI_STYLE_PROMPTS: Record<AIStyle, string> = {
  ...
  [AIStyle.CARTOON]: "Transform this photo into an upscale Polo Bar scene. Dress every person in well-fitted Ralph Lauren polo shirts, each in a different classic color with subtle logos. Keep all faces, expressions, and overall composition the same while placing them in a refined Polo Bar setting with polished wood, leather seating, and warm ambient lighting.",
};
