    ...
    <div className="relative w-full h-full flex flex-col items-center justify-center p-8 text-center bg-yellow-300/50">
      ...
      <div className="z-10 bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-lg">
        ...
        <div className="flex flex-col gap-4 w-full max-w-xs mx-auto">
            ...
            className="bg-purple-700 text-white font-bold py-3 px-8 rounded-full text-lg shadow-md hover:bg-purple-800 transform hover:scale-105 transition-all duration-300 ease-in-out"
            >
            View Gallery 🖼️
            </button>
        </div>
